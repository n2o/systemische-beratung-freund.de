...
export default function Leistungen() {
  return (
    <>
      <Head>
        <title>Systemische Beratung Freund: Datenschutz</title>
      </Head>
      <Header />
      <main>
        ...
        <Container>
          ...
          <ul className="list-inside list-disc pb-3 pl-5">
            <li>
          ...
          <p>
            ...
            Road, Cambridge, CB4 0WS, Großbritannien, ein. Großbritannien gilt
            ...
            der OpenStreetMap-Foundation hergestellt. Dabei können u.&nbsp;a.
            Ihre IP-Adresse und weitere Informationen über Ihr Verhalten auf
